...
# Add backend folder to path so we can import our models
sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

# Import our Base and ALL models so Alembic can detect them
from database import Base
import models  # this triggers all model imports via __init__.py
...
# This is the metadata Alembic uses to compare against DB
